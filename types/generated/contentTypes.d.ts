...
export interface ApiEstablecimientoEstablecimiento
  extends Schema.CollectionType {
...
export interface ApiHotelHotel extends Schema.CollectionType {
  ...
  attributes: {
    ...
    ubicacion_geografica: Attribute.String;
...
export interface ApiResturantResturant extends Schema.CollectionType {
  collectionName: 'resturantes';
  info: {
    singularName: 'resturant';
    pluralName: 'resturantes';
    displayName: 'Resturantes';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    rango_precios: Attribute.String;
    establecimiento: Attribute.Relation<
      'api::resturant.resturant',
      'oneToOne',
      'api::establecimiento.establecimiento'
...
export interface ApiTransporteTransporte extends Schema.CollectionType {
